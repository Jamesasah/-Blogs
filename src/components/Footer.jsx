        ...
        <div className='grid mb-8 lg:grid-cols-6'>
          <div className='grid grid-cols-2 gap-5 lg: col-span-4 md:grid-cols-4'>
            ...
            <div>
                ...
                <p className='font-medium tracking-wide text-gray-300'>Subscripe for updates</p>
                ...
                <p className='mt-4 text-sm text-gray-500'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Illo sed doloribus nihil, voluptate quam harum. Reiciendis vero amet culpa aliquid accusamus, minus deleniti aliquam nulla?</p>
            </div>
        </div>
